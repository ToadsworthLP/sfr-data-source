...
public class WeatherMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static fpr.weatherservice.serializer.WeatherMessage.Builder newBuilder() {
    return new fpr.weatherservice.serializer.WeatherMessage.Builder();
  }
   ...
   * @return A new WeatherMessage RecordBuilder
   */
  public static fpr.weatherservice.serializer.WeatherMessage.Builder newBuilder(fpr.weatherservice.serializer.WeatherMessage.Builder other) {
    if (other == null) {
      return new fpr.weatherservice.serializer.WeatherMessage.Builder();
    } else {
      return new fpr.weatherservice.serializer.WeatherMessage.Builder(other);
    }
  }
   ...
   * @return A new WeatherMessage RecordBuilder
   */
  public static fpr.weatherservice.serializer.WeatherMessage.Builder newBuilder(fpr.weatherservice.serializer.WeatherMessage other) {
    if (other == null) {
      return new fpr.weatherservice.serializer.WeatherMessage.Builder();
    } else {
      return new fpr.weatherservice.serializer.WeatherMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WeatherMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(fpr.weatherservice.serializer.WeatherMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(fpr.weatherservice.serializer.WeatherMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.timestamp)) {
        this.timestamp = data().deepCopy(fields()[0].schema(), other.timestamp);
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder setTimestamp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder clearTimestamp() {
      timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder setTemperature(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder clearTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder setTemperatureUnit(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder clearTemperatureUnit() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder setPressure(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder clearPressure() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder setPressureUnit(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fpr.weatherservice.serializer.WeatherMessage.Builder clearPressureUnit() {
      pressure_unit = null;
